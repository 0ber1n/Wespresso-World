    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/beans/*/reviews").permitAll()
                .requestMatchers(HttpMethod.POST, "/beans/*/reviews").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/beans/*/reviews/*").hasRole("admin")
                ...
                .requestMatchers("/vuln-flags").permitAll()
